...
The excel sheet is supposed to be located in the data folder. The root folder is `r here()`.
...
```{r}
read_play_jsonl(here("data", "Mascarade_mod.jsonl")) -> play1
read_play_jsonl(here("data", "GertWestphaler1724_mod.jsonl")) -> play2
read_play_jsonl(here("data", "Barselstuen_mod.jsonl")) -> play3
