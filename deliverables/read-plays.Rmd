...
One of the TEI files contains some text surrounded by double quotes, which the `read_plays_jsonl` function cannot handle. Therefore we need to transform these quotes to single quotes.

```{r}
clean_Mascarade(here("data","Mascarade_mod.page"))
```
