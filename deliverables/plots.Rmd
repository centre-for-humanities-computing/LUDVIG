...
Let's first test this on a single play. Note, the plot_all-function assumes the existence of three specific subfolders ind the plots-folder: hvem-taler-hvornaar, hvem-til-stede, and hvem-til-stede-hvem-omtalt. 
